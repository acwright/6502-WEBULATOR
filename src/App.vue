<template>
  <header class="flex flex-row justify-between items-center bg-white pl-2 pr-2 text-black">
    <h1 class="text-4xl mt-1">6502</h1>
    <a href="https://github.com/acwright/6502-WEBULATOR">
...
// Save persistence data whenever the emulator stops
